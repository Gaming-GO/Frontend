    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={{ flex: 2, backgroundColor: '#fff' }}>
        ...
        <View style={{ marginTop: 60 }}>
          ...
          {/* <Text style={{ fontWeight: 'bold', fontSize: 20, textAlign: 'center' }}>{user.username ? user.username : user.email.split('@')[0]}</Text> */}
          <Text style={{ fontWeight: 'bold', fontSize: 20, textAlign: 'center' }}>{user.username ? user.username : 'username..'}</Text>
